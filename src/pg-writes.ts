...
export async function pgUpdateChatName(
  chatJid: string,
  name: string,
): Promise<void> {
  await query(
...
export async function pgSetRouterState(
  key: string,
  value: string,
): Promise<void> {
  await query(
...
export async function pgSetSession(
  groupFolder: string,
  sessionId: string,
): Promise<void> {
  await query(
...
export async function pgSetRegisteredGroup(
  jid: string,
